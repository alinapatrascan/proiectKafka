...
topic    = TOPICS["health"]
csv_path = os.path.join(DATA_DIR, "health.csv")
key_col  = "respondent_id"

print(f"Topic: {topic}")
print(f"Key: {key_col} — datele de sanatate ale aceluiasi respondent merg in aceeasi partitie")
...
producer.flush()
print("-" * 60)
print("Producer health finished.")
